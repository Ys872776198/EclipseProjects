...
public class ScanAPIHandler {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="api-scan-read-book/{userId}/{bookId}")
	public String readBook(@PathVariable("userId") Integer userId, @PathVariable("bookId") Integer bookId) {
//		if (!borrowService.addBorrow(bookId, userId)) {
//			return "-1";
//		}
		
		return borrowService.addAndread(bookId, userId);
	}
...
//	@RequestMapping(value="api-scan-borrow-history/{id}")
//	public ArrayList<Borrow> getBorrowHistory(@PathVariable("id") Integer userId) {
//		return (ArrayList<Borrow>) borrowService.getBorrowByUser(userId);
//	}
