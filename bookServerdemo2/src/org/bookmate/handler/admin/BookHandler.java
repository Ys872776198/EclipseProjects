...
//			@RequestParam("bookGrade") Integer bookGrade,@RequestParam("bookNumber") Integer bookNumber, 
//			@RequestParam("bookBigImage") String bookBigImage, @RequestParam("bookSmallImage") String bookSmallImage,@RequestParam("bookAddress") String bookAddress) {
//		bookService.addBook2(bookNumber, bookName, bookAuthor, bookPress, bookBigImage, bookSmallImage,
//				bookClassifyOne, bookClassifyTwo, bookDesc,bookGrade,bookAddress);
...
//	}
	...
	public String addBookExcute(@RequestParam("bookName") String bookName, @RequestParam("bookAuthor") String bookAuthor, 
			@RequestParam("bookPress") String bookPress, @RequestParam("bookClassifyOne") String bookClassifyOne, 
			@RequestParam("bookClassifyTwo") String bookClassifyTwo, @RequestParam("bookDesc")String bookDesc,
			@RequestParam("bookAddress") String bookAddress,
		...
		bookService.addBook2(bookNumber, bookName, bookAuthor, bookPress, bookBigImage, bookSmallImage,
				bookClassifyOne, bookClassifyTwo, bookDesc, bookAddress,  1.0);
		String view = "redirect:/admin-book-list-show?page=1";
		return view;
	...
	public String editBookExecute(@RequestParam("bookName") String bookName, @RequestParam("bookAuthor") String bookAuthor, 
			@RequestParam("bookPress") String bookPress, @RequestParam("bookClassifyOne") String bookClassifyOne, 
			@RequestParam("bookClassifyTwo") String bookClassifyTwo, @RequestParam("bookDesc")String bookDesc,
			@RequestParam("bookNumber") Integer bookNumber, @RequestParam("bookGrade") Double bookGrade,@RequestParam("bookAddress") String bookAddress,
		...
		bookService.updateBook(id, bookNumber, bookName, bookAuthor, bookPress,
				bookBigImage, bookSmallImage, bookClassifyOne, bookClassifyTwo, bookDesc,bookGrade,bookAddress);
