                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form autocomplete="off" class="am-form tpl-form-line-form" action="${pageContext.request.contextPath }/admin-book-editbook-execute" method="post">
                                    ...
                                    <div class="am-form-group">
                                        <label for="book-press" class="am-u-sm-3 am-form-label">评分(1-5之间)</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="" placeholder="" name="bookGrade" value="${requestScope.book.bookGrade }"></input>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                        	<input type="text" class="tpl-form-input" id="" placeholder="" name="bookAddress" value="${requestScope.book.bookAddress }"></input>
                                        </div>
                                    </div>
